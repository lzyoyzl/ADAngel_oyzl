...
class TestProjectContract(unittest.TestCase):
    ...
    def test_o3_o4_production_backend_contract(self):
        ...
        self.assertIn(
            'using O3M64N16K128Config = O3Config<16, 1, false, 64>', o3
        )
        self.assertIn(
            'using O3M64N32K128Config = O3Config<32, 1, false, 64>', o3
        )
        self.assertIn(
        ...
        self.assertIn('bmma_accumulator_chains', o4)
        self.assertIn('b_fragment_cached', o4)
    ...
    def test_o2_production_backend_contract(self):
        ...
        cli = (ROOT / "python/adangel/cli.py").read_text()
        ...
        self.assertIn('stability_policy: str = "strict"', report)
