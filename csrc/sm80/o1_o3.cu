...
py::dict benchmark(std::string variant,std::string mode,at::Tensor a,at::Tensor as,
  ...
  const bool o3_candidate=split&&(implementation=="o3_swizzle_64x64_k128_magic"||
      implementation=="o3_swizzle_64x128_k256_exp_merge_static_stream_bound2"||
      ...
      implementation=="o3_swizzle_64x128_k256_exp_static_stream_bound2_scale2"||
      implementation=="o3_swizzle_64x128_k256_exp_static_stream_bound2_store2_scale2"||
  ...
  if(implementation=="o3_swizzle_64x128_k256_exp_merge_static_stream_bound2") {
    if(exponent_scale) o3_configure<64,128,256,true,false,false,2,true,true,false,true,true>(); else o3_configure<64,128,256,false,false,false,2,true,true,false,true,true>();
  }
  ...
  if(implementation=="o3_swizzle_64x128_k256_exp_static_stream_bound2_store2") {
    if(exponent_scale) o3_configure<64,128,256,true,false,false,2,false,true,false,true,true,true>(); else o3_configure<64,128,256,false,false,false,2,false,true,false,true,true,true>();
  }
  if(implementation=="o3_swizzle_64x128_k256_exp_static_stream_bound2_scale2") {
    if(exponent_scale) o3_configure<64,128,256,true,false,false,2,false,true,false,true,true,false,true>(); else o3_configure<64,128,256,false,false,false,2,false,true,false,true,true,false,true>();
  }
  if(implementation=="o3_swizzle_64x128_k256_exp_static_stream_bound2_store2_scale2") {
    if(exponent_scale) o3_configure<64,128,256,true,false,false,2,false,true,false,true,true,true,true>(); else o3_configure<64,128,256,false,false,false,2,false,true,false,true,true,true,true>();
  }
  ...
  auto gemm=[&](){
    ...
    else if(implementation=="o3_swizzle_64x128_k256_exp_merge_static_stream_bound2") {
      if(exponent_scale) o3_launch<64,128,256,true,false,false,2,true,true,false,true,true>(aa,wa,as,ws,out,stream); else o3_launch<64,128,256,false,false,false,2,true,true,false,true,true>(aa,wa,as,ws,out,stream);
    }
    ...
    else if(implementation=="o3_swizzle_64x128_k256_exp_static_stream_bound2_store2") {
      if(exponent_scale) o3_launch<64,128,256,true,false,false,2,false,true,false,true,true,true>(aa,wa,as,ws,out,stream); else o3_launch<64,128,256,false,false,false,2,false,true,false,true,true,true>(aa,wa,as,ws,out,stream);
    }
    else if(implementation=="o3_swizzle_64x128_k256_exp_static_stream_bound2_scale2") {
      if(exponent_scale) o3_launch<64,128,256,true,false,false,2,false,true,false,true,true,false,true>(aa,wa,as,ws,out,stream); else o3_launch<64,128,256,false,false,false,2,false,true,false,true,true,false,true>(aa,wa,as,ws,out,stream);
    }
    else if(implementation=="o3_swizzle_64x128_k256_exp_static_stream_bound2_store2_scale2") {
      if(exponent_scale) o3_launch<64,128,256,true,false,false,2,false,true,false,true,true,true,true>(aa,wa,as,ws,out,stream); else o3_launch<64,128,256,false,false,false,2,false,true,false,true,true,true,true>(aa,wa,as,ws,out,stream);
    }
  ...
  if(o3_candidate) meta["output_store_bits"]=implementation.find("_store2")!=std::string::npos?64:32;
  if(o3_candidate) meta["scale_load_bits"]=implementation.find("_scale2")!=std::string::npos?16:8;
  if(o3_candidate&&implementation.find("_stream")!=std::string::npos)
    meta["weight_register_slice_n"]=32;
  if(o3_candidate) meta["warp_operand_boundary"]=implementation.find("_bound2")!=std::string::npos&&implementation.find("_stream")!=std::string::npos&&implementation.find("_merge")!=std::string::npos;
